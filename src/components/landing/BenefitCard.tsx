...
export const BenefitCard = () => {
  return (
    <section className="container px-4 py-12 sm:py-16">
      <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-card p-6 shadow-brand sm:p-10">
        <div className="absolute -right-16 -top-16 h-56 w-56 rounded-full bg-gradient-brand opacity-20 blur-3xl" aria-hidden />
